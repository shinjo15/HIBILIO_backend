...
use Src\Account\Application\Usecase\Command\ApproveFollowRequest\ApproveFollowRequest;
...
use Src\Account\Application\Usecase\Command\ChangeAccountUiMode\ChangeAccountUiMode;
...
use Src\Account\Application\Usecase\Command\RejectFollowRequest\RejectFollowRequest;
...
use Src\Account\Infrastructure\Factory\FollowRequestFactory;
...
use Src\Account\Infrastructure\Repository\FollowRequestRepository;
...
use Src\Authentication\Infrastructure\Repository\AuthenticatedAccountStateRepository;
...
use Src\Authentication\Infrastructure\Service\LaravelPersistentLoginTokenHashService;
...
use Src\Authentication\Infrastructure\Service\RandomPersistentLoginTokenGeneratorService;
...
use Src\Authentication\Infrastructure\Service\SystemPersistentLoginClockService;
...
use Src\Routine\Infrastructure\Query\SearchRoutines\SearchRoutines;
...
use Src\RoutineExecution\Infrastructure\Query\GetRoutineExecutionDetails\GetRoutineExecutionDetails;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(PendingSocialRegistrationSessionServiceInterface::class, LaravelPendingSocialRegistrationSessionService::class);
        ...
        $this->app->bind(PersistentLoginCookieServiceInterface::class, LaravelPersistentLoginCookieService::class);
        $this->app->bind(PersistentLoginTokenGeneratorServiceInterface::class, RandomPersistentLoginTokenGeneratorService::class);
        $this->app->bind(PersistentLoginTokenHashServiceInterface::class, LaravelPersistentLoginTokenHashService::class);
        $this->app->bind(PersistentLoginClockServiceInterface::class, SystemPersistentLoginClockService::class);
        $this->app->bind(AuthenticatedAccountStateRepositoryInterface::class, AuthenticatedAccountStateRepository::class);
        $this->app->bind(GetAuthenticatedAccountStateInterface::class, GetAuthenticatedAccountState::class);
        $this->app->bind(IssuePersistentLoginInterface::class, IssuePersistentLogin::class);
        $this->app->bind(RestorePersistentLoginInterface::class, RestorePersistentLogin::class);
        ...
        $this->app->bind(ChangeAccountUiModeInterface::class, ChangeAccountUiMode::class);
        ...
        $this->app->bind(GetSentFollowRequestsInterface::class, GetSentFollowRequests::class);
        ...
        $this->app->bind(FollowRequestFactoryInterface::class, FollowRequestFactory::class);
        ...
        $this->app->bind(SearchAccountsInterface::class, SearchAccounts::class);
        ...
        $this->app->bind(SearchRoutinesInterface::class, SearchRoutines::class);
        ...
        $this->app->bind(GetRoutineExecutionDetailsInterface::class, GetRoutineExecutionDetails::class);
