...
final readonly class GetFavoriteTagPostsAction
{
    public function __construct(
        private GetFavoriteTagPostsInterface $getFavoriteTagPosts,
        private AuthServiceInterface $authService,
    ) {}

    public function __invoke(GetFavoriteTagPostsRequest $request): JsonResponse
    {
        try {
