...
final class AccountRepository implements AccountRepositoryInterface
{
    ...
    public function save(Account $account): void
    {
        DB::transaction(function () use ($account): void {
            $values = ['account_name' => $account->accountName()->value(), 'account_bio' => $account->accountBio()?->value(), 'email_address' => $account->emailAddress()->value(), 'status' => $account->status()->value, 'ban_until' => $account->banUntil(), 'visibility' => $account->visibility()->value, 'ui_mode' => $account->uiMode()->value];
